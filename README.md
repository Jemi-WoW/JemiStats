...
**JemiStats** is a World of Warcraft Classic addon that tracks what your character actually did.
...
*   **Class stats** - a tracked signature ability for every Classic class
